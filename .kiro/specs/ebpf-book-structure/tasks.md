...
- [x] 4. Escribir Parte I — Nivel Novato (Capítulos 1-5)
  ...
  - [x] 4.3 Escribir Capítulo 3: Tu laboratorio de guerra
  ...
  - [x] 4.4 Crear código de ejemplos y ejercicio del Capítulo 3
  ...
  - [x] 4.5 Escribir Capítulo 4: Hello World — Tu primer hook
  ...
  - [x] 4.6 Crear código de ejemplos y ejercicio del Capítulo 4
  ...
  - [x] 4.7 Escribir Capítulo 5: De novato a intermedio — El puente
...
- [x] 6. Escribir Parte II — Nivel Intermedio (Capítulos 6-13)
  ...
  - [x] 6.3 Escribir Capítulo 7: El Verifier — Tu enemigo favorito
  ...
  - [x] 6.5 Escribir Capítulo 8: Helper functions — El arsenal
  ...
  - [x] 6.17 Escribir introducción de Parte II
