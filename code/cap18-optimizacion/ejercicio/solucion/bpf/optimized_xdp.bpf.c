...
//
// Antes de optimizar (naive):
//   - Hash map compartido para stats → contención
//   - Funciones no inlined → overhead de call
//   - Sin branch hints → pipeline stalls
//
// Después de optimizar:
//   - Per-CPU array → zero lock contention
//   - Todo inlined → zero call overhead
//   - Hints en hot path → mejor branch prediction
//
// Attach point: XDP
