// Capítulo 13 — Solución Ejercicio Integrador: Process Lifecycle Monitor
//
...
func main() {
	...
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println("  Process Lifecycle Monitor — Capítulo 13 (Solución)")
	fmt.Println("═══════════════════════════════════════════════════════════════")
	fmt.Println()
	...
	// Tracepoint sched/sched_process_fork — detecta creación de procesos.
	...
	// Tracepoint sched/sched_process_exit — detecta terminación de procesos.
