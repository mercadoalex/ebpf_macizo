...
// event_logger.bpf.c — Ejercicio Capítulo 12: Event Logger con Ring Buffer
//
...
//
// NOTA: Este programa ya está completo. Tu trabajo es implementar
// el consumer en Go (go/main.go).
//
// Attach points:
